...
Format: Include `**You MUST read CLAUDE.md BEFORE DOING ANYTHING** because it is critical that you properly understand the high level details and conventions of this project` in your delegation prompt.
